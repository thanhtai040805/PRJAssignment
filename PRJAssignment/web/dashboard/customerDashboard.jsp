...
<div class="container" style="max-width:1200px;margin:40px auto;background:#fff;padding:30px;border-radius:10px;box-shadow:0 4px 16px rgba(0,0,0,0.08);">
    <h2 style="color:#007bff;">Quản lý Khách hàng</h2>
    ...
    <button style="margin-top:20px;background:#28a745;color:#fff;border:none;padding:8px 20px;border-radius:6px;font-weight:600;">Thêm khách hàng</button>
</div>