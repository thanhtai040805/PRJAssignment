...
<header class="header">
    <div class="header-content">
        ...
        <div class="auth-links">
            ...
            <c:if test="${sessionScope.currentUser != null && sessionScope.currentUser.role == 'nhanvien'}">
                <a href="${pageContext.request.contextPath}/employee/loadInvoices" class="dashboard-link" title="Quản lý hóa đơn">
                    <span style="font-size: 18px;">🧾</span> Hóa đơn
                </a>
            </c:if>
