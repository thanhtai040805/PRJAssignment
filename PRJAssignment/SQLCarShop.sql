...
(N'Mitsubishi', N'Nhật Bản', 'www.mitsubishi.com', N'Thương hiệu ô tô hàng đầu Nhật Bản, giá cả phải chăng'),
(N'Suzuki', N'Nhật Bản', 'www.suzuki.com', N'Thương hiệu ô tô Nhật Bản năng động và nổi tiếng'),
(N'VinFast', N'Việt Nam', 'www.vinfast.com', N'Thương hiệu ô tô điện hàng đầu Việt nam, thân thiện với môi trường'),
(N'BMW', N'Đức', 'www.bmw.com', N'Thương hiệu ô tô hàng đầu Đức, sang trọng và quý phái'),
(N'Mercedes', N'Đức', 'www.bmw.com', N'Thương hiệu ô tô hàng đầu Đức, thiết kế hiện đại, tiệm cận tương lai'),
(N'Audi', N'Đức', 'www.bmw.com', N'Thương hiệu ô tô hàng đầu Đức, nổi tiếng với độ tin cậy cao'),
(N'Chevrolet', N'Mỹ', 'www.chevrolet.com', N'Thương hiệu ô tô Mỹ nổi tiếng với các dòng xe bán tải và SUV'),
(N'Nissan', N'Nhật Bản', 'www.nissan-global.com', N'Thương hiệu Nhật Bản nổi tiếng với sự bền bỉ và đổi mới công nghệ'),
(N'Peugeot', N'Pháp', 'www.peugeot.com', N'Thương hiệu ô tô Pháp với thiết kế thanh lịch và tiết kiệm nhiên liệu'),
(N'Citroën', N'Pháp', 'www.citroen.com', N'Hãng xe Pháp với phong cách độc đáo và trải nghiệm lái êm ái'),
(N'Volvo', N'Thụy Điển', 'www.volvocars.com', N'Thương hiệu Thụy Điển nổi bật với độ an toàn cao và thiết kế tối giản'),
(N'Tesla', N'Mỹ', 'www.tesla.com', N'Thương hiệu tiên phong trong lĩnh vực xe điện và công nghệ tự lái'),
(N'Jaguar', N'Anh', 'www.jaguar.com', N'Thương hiệu xe sang Anh quốc với thiết kế tinh tế và hiệu suất mạnh mẽ'),
(N'Land Rover', N'Anh', 'www.landrover.com', N'Hãng xe địa hình cao cấp của Anh với khả năng vượt mọi địa hình'),
(N'Ferrari', N'Ý', 'www.ferrari.com', N'Thương hiệu siêu xe thể thao nổi tiếng toàn cầu đến từ Ý'),
(N'Lamborghini', N'Ý', 'www.lamborghini.com', N'Thương hiệu siêu xe Ý nổi bật với thiết kế táo bạo và tốc độ vượt trội'),
(N'Maserati', N'Ý', 'www.maserati.com', N'Thương hiệu xe sang thể thao cao cấp đến từ Ý'),
(N'Rolls-Royce', N'Anh', 'www.rolls-roycemotorcars.com', N'Thương hiệu xe siêu sang Anh quốc, biểu tượng của đẳng cấp'),
(N'Bentley', N'Anh', 'www.bentleymotors.com', N'Thương hiệu xe siêu sang với hiệu suất cao và nội thất xa hoa'),
(N'Porsche', N'Đức', 'www.porsche.com', N'Thương hiệu xe thể thao nổi tiếng của Đức với thiết kế tinh tế và mạnh mẽ'),
(N'Subaru', N'Nhật Bản', 'www.subaru.com', N'Hãng xe Nhật nổi bật với hệ dẫn động bốn bánh và độ an toàn cao'),
(N'Daihatsu', N'Nhật Bản', 'www.daihatsu.com', N'Thương hiệu ô tô nhỏ gọn nổi tiếng tại thị trường châu Á'),
(N'BYD', N'Trung Quốc', 'www.byd.com', N'Thương hiệu xe điện hàng đầu Trung Quốc với công nghệ pin hiện đại'),
(N'Geely', N'Trung Quốc', 'www.geely.com', N'Hãng xe Trung Quốc với tốc độ phát triển nhanh và sở hữu nhiều thương hiệu quốc tế'),
(N'Chery', N'Trung Quốc', 'www.cheryinternational.com', N'Thương hiệu ô tô Trung Quốc giá cả cạnh tranh và ngày càng phổ biến'),
(N'Baojun', N'Trung Quốc', 'www.sgmw.com.cn', N'Hãng xe liên doanh giữa GM và SAIC, nổi bật tại thị trường nội địa Trung Quốc'),
(N'Lexus', N'Nhật Bản', 'www.lexus.com', N'Thương hiệu xe sang của Toyota, nổi bật với sự tinh tế, bền bỉ và trải nghiệm cao cấp'),
(N'Volkswagen', N'Đức', 'www.vw.com', N'Thương hiệu ô tô lớn nhất châu Âu, nổi tiếng với các mẫu xe phổ thông và chất lượng bền bỉ'),
(N'MG', N'Anh/Trung Quốc', 'www.mgmotor.com', N'Thương hiệu ô tô Anh quốc lâu đời, nổi bật với thiết kế hiện đại và giá thành hợp lý'),
(N'Changan', N'Trung Quốc', 'www.globalchangan.com', N'Một trong những hãng ô tô lớn nhất Trung Quốc, nổi bật với các mẫu xe điện và xe giá rẻ');
GO
...
(7, N'Xpander', N'Van', 7, N'Xăng', N'MPV 7 chỗ linh hoạt cho gia đình'),
(7, N'Outlander', N'SUV', 7, N'Xăng', N'SUV 7 chỗ với thiết kế thể thao'),
(8, N'XL7', N'SUV', 7, N'Xăng', N'SUV 7 chỗ giá rẻ cho thị trường Việt Nam'),
(9, N'VinFast Lux A', N'Sedan', 5, N'Xăng', N'Sedan hạng D của VinFast'),
(9, N'VinFast Fadil', N'Hatchback', 5, N'Xăng', N'Hatchback cỡ A của VinFast'),
(10, N'BMW 3 Series', N'Sedan', 5, N'Xăng', N'Sedan hạng sang của BMW'),
(11, N'Mercedes C-Class', N'Sedan', 5, N'Xăng', N'Sedan hạng sang của Mercedes-Benz'),
(12, N'Audi Q5', N'SUV', 5, N'Xăng', N'SUV hạng sang của Audi'),
(33, N'Lexus RX', N'SUV', 5, N'Hybrid', N'SUV hạng sang hybrid của Lexus'),
(15, N'Peugeot 3008', N'SUV', 5, N'Xăng', N'SUV Pháp với thiết kế độc đáo'),
(34, N'Volkswagen Tiguan', N'SUV', 5, N'Xăng', N'SUV Đức với chất lượng cao'),
(27, N'Subaru Forester', N'SUV', 5, N'Xăng', N'SUV với hệ dẫn động 4 bánh toàn thời gian'),
(35, N'MG HS', N'SUV', 5, N'Xăng', N'SUV Anh với giá cả hợp lý'),
(36, N'Changan CS75', N'SUV', 5, N'Xăng', N'SUV Trung Quốc với trang bị hiện đại'),
(17, N'Volvo XC60', N'SUV', 5, N'Xăng', N'SUV hạng sang Thụy Điển an toàn'),
(18, N'Tesla Model Y', N'SUV', 5, N'Điện', N'SUV điện cao cấp của Tesla'),
(11, N'Mercedes GLC', N'SUV', 5, N'Xăng', N'SUV hạng sang cỡ trung của Mercedes');
GO
...
ALTER TABLE XeOTo
ADD CONSTRAINT UQ_XeOTo_GlobalKey UNIQUE (GlobalKey);
...
-- Bảng lưu review chi tiết về xe
CREATE TABLE ReviewCars (
    ...
    Status NVARCHAR(20) NOT NULL DEFAULT N'Hiện',
    CONSTRAINT FK_ReviewCars_XeOTo FOREIGN KEY (GlobalKey) REFERENCES XeOTo(GlobalKey),
    CONSTRAINT FK_ReviewCars_Users FOREIGN KEY (UserID) REFERENCES Users(UserID),
    CONSTRAINT CK_ReviewCars_Status CHECK (Status IN (N'Hiện', N'Ẩn'))
);

-- Bảng lưu đánh giá điểm số (rating) về xe
CREATE TABLE CarRatings (
    RatingID INT IDENTITY(1,1) PRIMARY KEY,
    GlobalKey NVARCHAR(100) NOT NULL,
    UserID INT NOT NULL,
    Rating INT NOT NULL,
    ShortComment NVARCHAR(255) NULL,
    CreatedAt DATETIME NOT NULL DEFAULT GETDATE(),
    Status NVARCHAR(20) NOT NULL DEFAULT N'Hiện',
    CONSTRAINT FK_CarRatings_XeOTo FOREIGN KEY (GlobalKey) REFERENCES XeOTo(GlobalKey),
    CONSTRAINT FK_CarRatings_Users FOREIGN KEY (UserID) REFERENCES Users(UserID),
    CONSTRAINT CK_CarRatings_Rating CHECK (Rating >= 1 AND Rating <= 5),
    CONSTRAINT CK_CarRatings_Status CHECK (Status IN (N'Hiện', N'Ẩn')),
    CONSTRAINT UQ_CarRatings_XeID_UserID UNIQUE (GlobalKey, UserID) -- Mỗi user chỉ được đánh giá 1 xe 1 lần
);
