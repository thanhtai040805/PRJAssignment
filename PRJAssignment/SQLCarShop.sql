...
(1, 1, N'Toyota Camry 2.0G', 2023, N'Đen', 'TC2023002', 'TCE2023002', 1987, 169, N'CVT', 0, N'Mới', 1050000000, 1180000000, 3, '2023-02-20', N'/CarImage/2.jfif', N'ToyotaCamry2.0G2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(2, 1, N'Toyota Fortuner 2.7V', 2023, N'Bạc', 'TF2023001', 'TFE2023001', 2694, 166, N'Số tự động', 0, N'Mới', 1400000000, 1550000000, 1, '2023-03-10', N'/CarImage/3.jfif', N'ToyotaFortuner2.7V2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(3, 2, N'Honda Civic RS', 2023, N'Đỏ', 'HC2023001', 'HCE2023001', 1498, 178, N'CVT', 0, N'Mới', 850000000, 950000000, 2, '2023-01-25', N'/CarImage/4.jfif', N'HondaCivicRS2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(4, 2, N'Honda CR-V L', 2023, N'Xám', 'HR2023001', 'HRE2023001', 1498, 190, N'CVT', 0, N'Mới', 1150000000, 1280000000, 1, '2023-02-14', N'/CarImage/5.jfif', N'HondaCR-VL2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(5, 3, N'Hyundai Elantra 2.0', 2022, N'Trắng', 'HE2022001', 'HEE2022001', 1999, 159, N'CVT', 15000, N'Cũ', 650000000, 750000000, 1, '2023-04-05', N'/CarImage/6.jfif', N'HyundaiElantra2.02022' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(6, 3, N'Hyundai Tucson 2.0', 2023, N'Xanh', 'HT2023001', 'HTE2023001', 1999, 156, N'Số tự động', 0, N'Mới', 980000000, 1100000000, 2, '2023-03-20', N'/CarImage/7.jfif', N'HyundaiTucson2.02023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(8, 5, N'Mazda CX-5 Premium', 2023, N'Đen', 'MCX52023001', 'MCE2023001', 1998, 188, N'Số tự động', 0, N'Mới', 950000000, 1050000000, 2, '2023-04-01', N'/CarImage/8.jfif', N'MazdaCX-5Premium2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(5, 3, N'Mazda 3 Sport', 2023, N'Đỏ', 'M32023001', 'M3E2023001', 1496, 110, N'Số sàn', 0, N'Mới', 600000000, 720000000, 3, '2023-03-15', N'/CarImage/9.jfif', N'Mazda3Sport2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(9, 3, N'Kia Seltos 1.4 Turbo', 2023, N'Trắng', 'KS2023001', 'KSE2023001', 1353, 138, N'CVT', 0, N'Mới', 680000000, 770000000, 2, '2023-04-10', N'/CarImage/10.jfif', N'KiaSeltos1.4Turbo2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(10, 3, N'Kia Sorento Signature', 2023, N'Xám', 'KSO2023001', 'KSOE2023001', 2199, 198, N'Số tự động', 0, N'Mới', 1150000000, 1300000000, 1, '2023-04-18', N'/CarImage/11.jfif', N'KiaSorentoSignature2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(7, 4, N'Ford Ranger XLS', 2022, N'Xanh dương', 'FR2022001', 'FRE2022001', 2198, 160, N'Số sàn', 12000, N'Cũ', 700000000, 800000000, 1, '2023-05-05', N'/CarImage/12.jfif', N'FordRangerXLS2022' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(11, 4, N'Ford Everest Titanium', 2023, N'Trắng', 'FE2023001', 'FEE2023001', 1996, 210, N'Số tự động', 0, N'Mới', 1300000000, 1450000000, 1, '2023-06-01', N'/CarImage/13.jfif', N'FordEverestTitanium2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(12, 4, N'Mitsubishi Xpander Cross', 2023, N'Cam', 'MX2023001', 'MXE2023001', 1499, 105, N'CVT', 0, N'Mới', 650000000, 730000000, 2, '2023-05-12', N'/CarImage/14.jfif', N'MitsubishiXpanderCross2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(13, 4, N'Mitsubishi Outlander', 2022, N'Đen', 'MO2022001', 'MOE2022001', 2360, 165, N'Số tự động', 10000, N'Cũ', 800000000, 890000000, 1, '2023-06-10', N'/CarImage/15.jfif', N'MitsubishiOutlander2022' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(14, 4, N'Suzuki XL7', 2023, N'Bạc', 'SX2023001', 'SXE2023001', 1462, 103, N'CVT', 0, N'Mới', 620000000, 700000000, 3, '2023-06-20', N'/CarImage/16.jfif', N'SuzukiXL72023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(15, 5, N'VinFast Lux A2.0', 2021, N'Trắng', 'VL2021001', 'VLE2021001', 1998, 174, N'Số tự động', 5000, N'Cũ', 800000000, 880000000, 1, '2023-07-01', N'/CarImage/17.jfif', N'VinFastLuxA2.02021' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(16, 5, N'VinFast Fadil Plus', 2022, N'Xanh', 'VF2022001', 'VFE2022001', 1498, 98, N'CVT', 10000, N'Cũ', 400000000, 450000000, 2, '2023-07-10', N'/CarImage/18.jfif', N'VinFastFadilPlus2022' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(17, 6, N'BMW 320i Sport Line', 2022, N'Đỏ', 'BM3202022001', 'BME3202022001', 1998, 184, N'Số tự động', 7000, N'Cũ', 1500000000, 1650000000, 1, '2023-07-15', N'/CarImage/19.jfif', N'BMW320iSportLine2022' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(18, 6, N'Mercedes-Benz C200 Avantgarde', 2023, N'Xám', 'MB2023001', 'MBE2023001', 1496, 204, N'Số tự động', 0, N'Mới', 1690000000, 1850000000, 1, '2023-07-20', N'/CarImage/20.jfif', N'Mercedes-BenzC200Avantgarde2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(19, 1, N'Audi Q5 Sportback', 2023, N'Trắng', 'AQ52023001', 'AQ5E2023001', 1984, 249, N'Số tự động', 0, N'Mới', 2300000000, 2550000000, 1, '2023-07-25', N'/CarImage/21.jfif', N'AudiQ5Sportback2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(20, 1, N'Lexus RX500h F Sport', 2023, N'Đen', 'LRX2023001', 'LRXE2023001', 2393, 366, N'Số tự động', 0, N'Mới', 4300000000, 4700000000, 1, '2023-08-01', N'/CarImage/22.jfif', N'LexusRX500hFSport2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(21, 2, N'Peugeot 3008 Allure', 2023, N'Xám', 'P30082023001', 'P3E2023001', 1598, 165, N'Số tự động', 0, N'Mới', 1120000000, 1250000000, 1, '2023-08-05', N'/CarImage/23.jfif', N'Peugeot3008Allure2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(22, 2, N'Volkswagen Tiguan Elegance', 2022, N'Xanh rêu', 'VT2022001', 'VTE2022001', 1984, 180, N'Số tự động', 5000, N'Cũ', 1700000000, 1850000000, 1, '2023-08-10', N'/CarImage/24.jfif', N'VolkswagenTiguanElegance2022' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(23, 3, N'Subaru Forester i-S EyeSight', 2023, N'Trắng', 'SF2023001', 'SFE2023001', 1995, 156, N'CVT', 0, N'Mới', 1040000000, 1150000000, 2, '2023-08-15', N'/CarImage/25.jfif', N'SubaruForesteri-SEyeSight2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(24, 3, N'MG HS Trophy', 2023, N'Đỏ', 'MGHS2023001', 'MGHSE2023001', 1598, 225, N'Số tự động', 0, N'Mới', 850000000, 950000000, 1, '2023-08-20', N'/CarImage/26.jfif', N'MGHSTrophy2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(25, 4, N'Changan CS75 Plus', 2023, N'Bạc', 'CCS752023001', 'CCS75E2023001', 1499, 177, N'Số tự động', 0, N'Mới', 720000000, 800000000, 1, '2023-08-25', N'/CarImage/27.jfif', N'ChanganCS75Plus2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(26, 4, N'Volvo XC60 B6 AWD', 2023, N'Đen', 'VXC602023001', 'VXC60E2023001', 1969, 300, N'Số tự động', 0, N'Mới', 2800000000, 3050000000, 1, '2023-09-01', N'/CarImage/28.jfif', N'VolvoXC60B6AWD2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(27, 5, N'Tesla Model Y RWD', 2023, N'Trắng', 'TMY2023001', 'TMYE2023001', NULL, 220, N'Số tự động', 0, N'Mới', 1800000000, 1950000000, 1, '2023-09-05', N'/CarImage/29.jfif', N'TeslaModelYRWD2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5)),
(28, 6, N'Mercedes-Benz GLC300 4MATIC', 2023, N'Xám', 'MBGLC2023001', 'MBGLCE2023001', 1991, 258, N'Số tự động', 0, N'Mới', 2600000000, 2800000000, 1, '2023-09-10', N'/CarImage/30.jfif', N'Mercedes-BenzGLC3004MATIC2023' + RIGHT(CONVERT(VARCHAR(50), CRYPT_GEN_RANDOM(8)), 5));
